...
echo "L1_ENDPOINT_HTTP=$L1_ENDPOINT_HTTP" >> "simple-taiko-node/.env"
echo "L1_ENDPOINT_WS=$L1_ENDPOINT_WS" >> "simple-taiko-node/.env"
echo "ENABLE_PROVER=$ENABLE_PROVER" >> "simple-taiko-node/.env"
echo "L1_PROVER_PRIVATE_KEY=$L1_PROVER_PRIVATE_KEY" >> "simple-taiko-node/.env"
